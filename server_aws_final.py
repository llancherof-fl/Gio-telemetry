...
# ==========================================
# CONFIGURATION — 100% variables de entorno
# ==========================================
HOST          = '0.0.0.0'
    ...
    <body>
        ...
        <div class="main-grid">
            ...
            <div class="card">
                ...
                <div id="realtime-container"><p class="no-data">Esperando telemetria UDP...</p></div>
            </div>
        </div>
...
if __name__ == '__main__':
    ...
    if USE_HTTPS:
        ...
        if not os.path.exists(CERT_FILE):
            ...
            print("[!] Corre certbot primero o verifica la variable DOMAIN.")
            exit(1)
        ...
        print(f"[*] Test DB:   https://{DOMAIN}/test_db")
